...
import HOMESIDEBAR from '../assets/Home_sidebar.jpg'
import USER from '../assets/User.jpg'
import USER_1 from '../assets/User_1.jpg'
import PAYMENT from '../assets/Payment.jpg'
import PAYMENTSIDEBAR from '../assets/Payment_1.jpg'
import STAMP from '../assets/Stamp.jpg'
import STAMPSIDEBAR from '../assets/Stamp_1.jpg'
import PAYROLL from '../assets/Payroll.jpg'
import PAYROLLSIDEBAR from '../assets/Payroll_1.jpg'
import REPORT from '../assets/Report.jpg'
import REPORTSIDEBAR from '../assets/Report_1.jpg'
import SPEAKER from '../assets/Speaker.jpg'
import SEND from '../assets/Send.jpg'
import SENDSIDEBAR from '../assets/Send_1.jpg'
import PAGE from '../assets/Page.jpg'
import PAGESIDEBAR from '../assets/Account.jpg'
import DROPDOWN from '../assets/Dropdown_person.jpg'
import RAZORPAYLogo from '../assets/Razorpay_icon1.jpg'
    ...
    <div className='w-full'>
      <div className='h-screen flex flex-col'>
        ...
        <div className='bg-[#080d2a]'>
          ...
          <div className='flex justify-center p-1 bg-yellow-400 mx-[680px] rounded-b cursor-pointer'>
        ...
        <div className='flex'>
          ...
          {/* Sidebar  */}
          <div
            className={`absolute top-1 bottom-1 ${isHovered ? 'bg-[#242a4a]' : 'bg-[#080d2a]'} h-[733px] border-r-2 border-r-[#282d4d]`}
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
          >
            <div className={`flex flex-col ${isHovered ? 'py-1' : 'p-1'} justify-center`}>
              <div>
                <img
                  src={isHovered ? RAZORPAYLogo : LOGO}
                  alt="logo_icon"
                  className={isHovered ? 'w-[203px] py-3 pt-[3px] pr-12 pl-[7px]' : 'w-7 py-2'}
                />

                <div className='space-y-8 mt-3'>
                  {isHovered ? (
                    <>
                      {/* Hovered Sidebar Content */}
                      <div className='flex items-center p-1 space-x-3 pl-[11px] cursor-pointer'>
                        <img src={HOMESIDEBAR} alt="home" className='w-[12px]' />
                        <div className='text-[11px] font-semibold text-[#8d91ac] mt-[1px]'>Home</div>
                      </div>
                      <div className='text-[#a1a2b6] flex items-center pl-[11px] space-x-3 cursor-pointer'>
                        <ArrowOutwardIcon sx={{ fontSize: 14 }} />
                        <div className='text-[11px] font-semibold text-[#8d91ac] mt-[1px]'>Payouts</div>
                        <div className='text-[7px] text-white font-bold px-1 py-[1px] rounded-full bg-[#008456] mt-1'>New</div>
                      </div>
                      <div className='flex items-center pl-[11px] space-x-3 cursor-pointer'>
                        <img src={PAGESIDEBAR} alt="payment" className='w-[11px] mr-1 bg-[#363b59]' />
                        <div className='text-[11px] font-semibold text-[#8d91ac]'>Account Statement</div>
                      </div>
                      <div className='flex items-center bg-[#383d5a] py-[1px] cursor-pointer'>
                        <div className="w-[2px] bg-amber-500 rounded-r-full h-4 mr-1"></div>
                        <img src={USER} alt="" className='w-[15px] rounded bg-[#363b59] p-[1px] pl-[2px]' />
                        <div className='text-white text-[10px] font-bold mt-1 ml-4'>Contacts</div>
                        <div className='ml-[100px] pb-[1px] rounded-l-sm bg-[#4a506a] my-[1px]'>
                          <Add sx={{ color: 'white', fontSize: 25, fontWeight: 'bold', padding: '5px' }} />
                        </div>
                      </div>
                      <div className='space-y-8 mt-8 border-t-[1px] pt-7 border-t-[#323755] '>
                        <div className='flex items-center pl-[11px] space-x-3 cursor-pointer'>
                          <img src={PAYMENTSIDEBAR} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                          <div className='text-[11px] font-semibold text-[#8d91ac]'>Vendors Payments</div>
                        </div>
                        <div className='flex items-center pl-[11px] space-x-3 cursor-pointer'>
                          <img src={STAMPSIDEBAR} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                          <div className='text-[11px] font-semibold text-[#8d91ac]'>Tax Payments</div>
                        </div>
                        <div className='flex items-center pl-[11px] space-x-3 cursor-pointer'>
                          <img src={SENDSIDEBAR} alt="send" className='w-[13px] mr-1 bg-[#363b59]' />
                          <div className='text-[11px] font-semibold text-[#8d91ac]'>Payout Links</div>
                        </div>
                        <div className='flex items-center pl-[11px] space-x-3 cursor-pointer'>
                          <img src={PAYROLLSIDEBAR} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                          <div className='text-[11px] font-semibold text-[#8d91ac]'>Payroll</div>
                        </div>
                        <div className='flex items-center pl-[11px] space-x-3 cursor-pointer'>
                          <img src={REPORTSIDEBAR} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                          <div className='text-[11px] font-semibold text-[#8d91ac]'>Reports</div>
                        </div>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div className='flex justify-center'>
                        <img src={HOME} alt="home" className='w-5 ml-1' />
                      </div>
                      <div className='text-[#a1a2b6] flex justify-center'>
                        <ArrowOutwardIcon sx={{ fontSize: 14 }} />
                      </div>
                      <div className='flex justify-center'>
                        <img src={PAGE} alt="payment" className='w-[11px] mr-1 bg-[#363b59]' />
                      </div>
                      <div className='flex'>
                        <div className="w-[2px] bg-amber-500 rounded-r-full h-4 mr-1"></div>
                        <img src={USER} alt="" className='w-[15px] rounded bg-[#363b59] p-[1px]' />
                      </div>
                      <div className='space-y-8 mt-8 border-t-[1px] pt-7 border-t-[#232743]'>
                        <div className='flex justify-center'>
                          <img src={PAYMENT} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                        </div>
                        <div className='flex justify-center'>
                          <img src={STAMP} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                        </div>
                        <div className='flex justify-center'>
                          <img src={SEND} alt="send" className='w-[13px] mr-1 bg-[#363b59]' />
                        </div>
                        <div className='flex justify-center'>
                          <img src={PAYROLL} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                        </div>
                        <div className='flex justify-center'>
                          <img src={REPORT} alt="payment" className='w-[13px] mr-1 bg-[#363b59]' />
                        </div>
                      </div>
                    </>
                  )}
            ...
            <div className='flex text-white items-center space-x-[60rem] pl-12 '>
              ...
              <div className='flex items-center space-x-5 mb-1'>
                ...
                <div className='flex text-[#6bafff] border-[1px] border-[#6bafff] items-center justify-center text-[13px] font-semibold 
                  my-[1px] rounded-sm cursor-pointer'>
                ...
                <img src={SPEAKER} alt="" className='w-[21px] cursor-pointer' />

                <img src={DROPDOWN} alt="" className='w-[21px] cursor-pointer' />
        ...
        <div className='bg-[#1d2345] h-screen flex flex-col'>
          <div className='pt-3 px-8 ml-7'>
            <div className='flex items-center bg-[#292c4b] pl-3 py-3 text-[#aab3d0] text-[12px] rounded'>
              ...
              <div className='ml-4 text-[#5774b2] font-semibold cursor-pointer'>Learn More</div>
            </div>
          </div>
          ...
          <div className='py-2 px-8 ml-7'>
            <div className='flex items-center space-x-[51rem]'>
              ...
              <div className='flex items-center space-x-2'>
                <RefreshIcon sx={{ color: '#85b8ff', marginRight: 1, cursor: 'pointer' }} />
                <MoreVertIcon sx={{ color: '#748cbc' , cursor: 'pointer'}} />
                <div className='flex'>
                  <div className='flex items-center space-x-2'>
                    <div className='flex items-center border-2 border-[#7998cf] text-[#5681d0] py-1 px-3 text-[11px] rounded-sm cursor-pointer'>
                    ...
                    <div className='flex text-white border-[1px] border-[#6bafff] items-center justify-center text-[13px] font-semibold 
                     my-[1px] rounded-sm bg-[#2b85f7] cursor-pointer'>
                      <div className='ml-2 mb-2 mr-1 '>< Add sx={{
                        fontSize: 11
                      }} /></div>
          ...
          {/* Table  */}
          <div className='ml-7'>
            <div className='rounded-full my-1 border-t border-[#323755] mx-8'></div>
            <div>
              <div className="p-4">
          ...
          <div className='rounded-full my-1 border-t border-[#323755] rounded-full'></div>

          <div className='mt-32 w-20 ml-[87rem]'>
            <div className=''>
              <div className='flex items-center bg-[#6f6be4] p-1 rounded-full cursor-pointer'>
