            ...
            <div className='w-full'>
                <div className='h-screen flex flex-col'>
                    ...
                    <div className='flex'>
                        ...
                        {/* Sidebar  */}
                        <div className='absolute top-1 bottom-1 bg-[#242a4a] h-[733px] border-r-2 border-r-[#282d4d]'>
                            <div className='flex flex-col bg-[#242a4a] py-1 justify-center'>

                                <div>
                                    <img src={RAZORPAYLogo} alt="logo_icon"
                                        className='w-[203px] py-3 pt-[3px] pr-12 pl-[7px]' />

                                    <div className='space-y-8 mt-3'>
                                        <div className='flex items-center p-1 space-x-3 pl-[11px]'>
                                            <img src={HOMESIDEBAR} alt="home"
                                                className='w-[12px] ' />
                                            <div className='text-[11px] font-semibold text-[#8d91ac]  mt-[1px]'>
                                                Home
                                            </div>
                                        ...
                                        <div className='text-[#a1a2b6] flex items-center pl-[11px] space-x-3'>
                                            <ArrowOutwardIcon sx={{
                                                fontSize: 14,
                                            }} />
                                        ...
                                        <div className='flex items-center pl-[11px] space-x-3'>
                                            <img src={PAGESIDEBAR} alt="payment"
                                                className='w-[11px] mr-1 bg-[#363b59]' />
                                            <div className='text-[11px] font-semibold text-[#8d91ac]'>Account Statement</div>
                                        </div>

                                        <div className='flex items-center bg-[#383d5a] py-[1px]'>
                                            <div className="w-[2px] bg-amber-500 rounded-r-full h-4 mr-1"></div>
                                            <img src={USER} alt=""
                                                className='w-[15px] rounded bg-[#363b59] p-[1px] pl-[2px]' />
                                            ...
                                            <div className='ml-[100px] pb-[1px] rounded-l-sm bg-[#4a506a] my-[1px]'>
                                                <Add sx={{
                                                    color: 'white', fontSize: 25, fontWeight: 'bold', padding: '5px'
                                                }} />
                                            </div>
                                        </div>
